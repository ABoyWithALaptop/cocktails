...
const About = () => {
    useGSAP(()=> {
        const splitText = SplitText.create("#about h2", {
            type: "words",
        })
        ...
        scrollTimeLine.from(splitText.words, {
            opacity: 1, duration: 1, yPercent: 100, ease: "expo.out", stagger: 0.02
        })
        ...
        <div className={"mb-16 md:px-0 px-5"}>
            <div className={'content'}>
                ...
                <div className={'sub-content'}>
                    <p>Every cocktail we serve is a reflection of our obsession with detail — from the first muddle to
                        the
